...
module.exports = new Event("interactionCreate", async (bot, interaction) => {
    ...
    if(interaction.isCommand()) {
        ...
        if(command.permission === "Développeur" && interaction.user.id !== "873704684274208768") return interaction.reply("Vous n'avez pas la permission requise pour exécuter cette commande !")
