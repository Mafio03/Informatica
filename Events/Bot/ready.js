...
module.exports = new Event("ready", async bot => {
    ...
    setTimeout(async () => {
        ...
        const activités = ["la v13 de discord.js", "le développement", "MAFIOSA03 ", `${bot.users.cache.size} utilisateurs`, `${bot.guilds.cache.size} serveurs`]
    ...
    let channel = bot.channels.cache.get("891856681473040414")
    ...
    collector.on("collect", async menu => {
        ...
        let giveawayrole = channel.guild.roles.cache.get("925762730231750676")
        let annoncerole = channel.guild.roles.cache.get("925762842722971738")
        let partenariatrole = channel.guild.roles.cache.get("925762962361319515")
