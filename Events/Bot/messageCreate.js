...
module.exports = new Event("messageCreate", async (bot, message) => {
    ...
    db.query(`SELECT * FROM serveur WHERE guildID = ${message.guild.id}`, async (err, req) => {
        ...
        if(commandFile.permission === "Développeur" && message.author.id !== "873704684274208768") return message.reply("Vous n'avez pas la permission requise pour exécuter cette commande !")
